...
[2] =	{{.900,.900,.900},	{.100,.100,.100},	"DATA:Badges/Vaygr.tga"}, -- Balcora Gate
[3] =	{{0.047,0.047,0.047},	{.561,0,.043},	"DATA:Badges/Vaygr.tga",{.921,.75,.419},"data:/effect/trails/vgr_trail_clr.tga"}, -- vaygr attackers -- Gate Attackers (el33t)
}