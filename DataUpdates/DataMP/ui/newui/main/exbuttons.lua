...
if (MPButton==nil) then
	function MPButton()
		return NewMenuButton("btnMultiplayer",		"$2621",	nil,	0,	LAYOUT_MENU_OUTLINED_BUTTONS,	"FEButtonStyle1_Alert_Outlined_Chipped",	"UI_ShowScreen('BetaPopupScreen', eTransition);")
	end
end
